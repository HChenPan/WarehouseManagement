...
<head>
    ...
    <script src="${ctx}/JavaScript/supplier.js" type="text/javascript"></script>
</head>

<body class="easyui-layout">
<div data-options="region:'center',border:false">
    <div class="easyui-layout" data-options="fit:true">
        <div id="p" class="easyui-panel" data-options="region:'north',split:false,border:false" style="padding:2px;background: #fafafa;height:47px;">
            <table cellpadding="5" cellspacing="1" border="0">
                <tr>
                    <td>供应商代码</td>
                    <td>
                        <input class="easyui-textbox" type="text" id="suppliercode1" style="width: 200px;"/>
                    </td>
                    <td>供应商名称</td>
                    <td>
                        <input class="easyui-textbox" type="text" id="suppliername1" style="width: 200px;"/>
                    </td>
                    <td>法定代表人</td>
                    <td>
                    ...
                    <td>
                        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-search'" onclick="suppliersearch()">查询</a>&nbsp;&nbsp;
                        <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-reload'" onclick="suppliersearchclean()">清空条件</a>
                    </td>
                </tr>
            </table>
        </div>
        <div data-options="region:'center',border:false">
            <table class="easyui-datagrid" id="supplierlist" data-options="fit:true"></table>
        </div>
    </div>
</div>
<div id="w" class="easyui-window" title="供应商基本信息录入" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:900px;height:500px;padding:10px;">
    <div style="padding:10px 20px 20px 20px">
        <form id="supplieradd" method="post">
            <table cellpadding="4" align="center">
                <tr>
                    <td>供应商代码</td>
                    <td>
                        <input class="easyui-textbox" data-options="required:true" style="width: 300px" name="suppliercode" id="suppliercode"/>
                        <input type="hidden" name="id" id="id"/>
                    </td>
                    <td>供应商名称</td>
                    <td>
                        <input class="easyui-textbox" data-options="required:true" style="width: 300px" name="suppliername" id="suppliername"/>
                    </td>
                </tr>
                <tr>
                    <td>法定代表人</td>
        ...
        <div style="text-align:center;padding:5px">
            <a href="javascript:void(0)" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" onclick="submitsupplierForm()">保存数据</a>
        </div>
    </div>
</div>
<div id="v" class="easyui-window" title="供应商基本信息详情" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:900px;height:500px;padding:10px;">
    <div style="padding:10px 20px 20px 20px">
        <form id="supplierdetail" method="post">
            <table cellpadding="4" align="center">
                <tr>
                    <td>供应商代码</td>
                    <td>
                        <input class="easyui-textbox" data-options="readonly:true" style="width: 300px" name="suppliercode"/>
                    </td>
                    <td>供应商名称</td>
                    <td>
                        <input class="easyui-textbox" data-options="readonly:true" style="width: 300px" name="suppliername"/>
                    </td>
                </tr>
                <tr>
                    <td>法定代表人</td>
