...
<head>
    ...
    <script src="${ctx}/JavaScript/callslip.js" type="text/javascript"></script>
</head>
        ...
        <form id="callslipadd" method="post">
            <table cellpadding="4" align="center">
                ...
                <tr>
                    <td>部门</td>
                    <td>
                        <select class="easyui-combotree" id="department" name="department" style="width: 150px" data-options="required:true,editable:false,limitToList:true,valueField:'id',textField:'name',url:'department/gettreedepart'">
                        </select>
                    </td>
                    <td>申请时间</td>
                    <td>
                        <input class="easyui-datebox" data-options="required:true" style="width: 150px" name="applydate" id="applydate"/>
                    </td>
                </tr>
                <tr>
                    <td>用途</td>
                ...
                <tr>
                    <td>工程号</td>
                    <td>
                        <input class="easyui-combogrid" data-options="limitToList:true, panelWidth:460,idField:'projectno',textField:'projectno',url:'projectnomanage/getall',
            							columns:[[{field:'projectno',title:'工程号',width:140},{field:'projectname',title:'工程名称',width:320},]]"
                               style="width: 140px;"name="projectno" id="projectno"/>
                    </td>
                    <td>工程名称</td>
                    <td>
                        <input class="easyui-textbox" data-options="required:false" style="width: 320px;" name="projectname" id="projectname"/>
                    </td>
                </tr>
                <tr>
                    <td>备注</td>
...
<div id="d" class="easyui-window" title="新增物资信息（需求单）" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width:900px;height:300px;padding:10px;">
    <div style="padding:10px 20px 20px 20px">
        <form id="goodsform" method="post">
            <table cellpadding="5" align="center">
                <tr>
                ...
                <tr>
                    <td>需求单号</td>
                    <td>
                        <input class="easyui-combogrid" id="plancode" name="plancode" data-options="required:true" style="width:400px"/>
                    </td>
                </tr>
                <tr>
                    <td>物资明细表</td>
