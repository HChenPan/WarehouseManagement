...
<head>
    ...
    <script src="${ctx}/JavaScript/warehousing.js" type="text/javascript"></script>
</head>
        ...
        <form id="rk" method="post">
            <table cellpadding="5" align="center">
                <tr>
                    ...
                    <td>仓库编码</td>
                    <td>
                        <input class="easyui-textbox" id="storehousecode" name="storehousecode" data-options="readonly:true" style="width:180px"/><input type="hidden" name="storehouseid" id="storehouseid"/>
                    </td>
                </tr>
                <tr>
                    <td>申请日期</td>
                ...
                <tr>
                    ...
                    <td>
                        <select class="easyui-combobox" style="width: 180px;" data-options="editable:false,limitToList:true,required:true" id="entryinfotype" name="entryinfotype">
                            ...
                            <option value="补录合同入库">补录合同入库</option>
                        </select>
                    </td>
                </tr>
                <tr>
        ...
        <form id="rklistschild" method="post">
            <table cellpadding="5" align="center">
                <tr>
                    <td>入库流水号</td>
                    <td>
                        <input class="easyui-textbox" id="rkcode2" name="rkcode" data-options="readonly:true" style="width:650px"/>
                ...
                <tr>
                    <td>合同号</td>
                    <td>
                        <select id="contractbasicid" name="contractbasicid" class="easyui-combogrid" style="width:100%" data-options="">
                        </select>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="2">
                        <table id="rkmxlist" class="easyui-datagrid"></table>
                    </td>
                </tr>
